...
public class DownloadService {
    ...
    public void invalidDownloadRequest(HttpSession session, 
        ...
        // メッセージを取得
        String mes1 = messageSource.getMessage("Somthing.Wrong1", null, locale);
        String mes2 = messageSource.getMessage("Somthing.Wrong2", null, locale);
        String mes3 = messageSource.getMessage("Somthing.Wrong3", null, locale);
