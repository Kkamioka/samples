...
public class TodoDaoImpl implements TodoDao {
    ...
    // Criteria APIによる検索
    @Override
    public Page<Todo> findByCriteria(TodoQuery todoQuery, Integer accountId, Pageable pageable) {
        ...
        // 所有者
        predicates.add(builder.and(builder.equal(root.get(Todo_.OWNER_ID), accountId)));
